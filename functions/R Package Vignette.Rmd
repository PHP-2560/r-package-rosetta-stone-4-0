...
```{r, eval = FALSE}
complete_table <- key_data(my_data)
```
...
```{r, eval=FALSE}
bgraph_key(complete_table, 5)
```


*graph generated will appear here?
